...
namespace AMS_PRO_MAX {
    ...
    public partial class DB_AMS_PRODataSet : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ItemsRow AddItemsRow(int ItemID, string Name, string Description, string Image, decimal Price, System.DateTime ExpiryDate, int QuantityAvailable) {
...
namespace AMS_PRO_MAX.DB_AMS_PRODataSetTableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Items] ([ItemID], [Name], [Description], [Image], [Price], [ExpiryDate], [QuantityAvailable]) VALUES (@ItemID, @Name, @Description, @Image, @Price, @ExpiryDate, @QuantityAvailable);
SELECT ItemID, Name, Description, Image, Price, ExpiryDate, QuantityAvailable FROM Items WHERE (ItemID = @ItemID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [ItemID] = @ItemID, [Name] = @Name, [Description] = @Description, [Image] = @Image, [Price] = @Price, [ExpiryDate] = @ExpiryDate, [QuantityAvailable] = @QuantityAvailable WHERE (([ItemID] = @Original_ItemID) AND ([Name] = @Original_Name) AND ((@IsNull_Image = 1 AND [Image] IS NULL) OR ([Image] = @Original_Image)) AND ([Price] = @Original_Price) AND ((@IsNull_ExpiryDate = 1 AND [ExpiryDate] IS NULL) OR ([ExpiryDate] = @Original_ExpiryDate)) AND ((@IsNull_QuantityAvailable = 1 AND [QuantityAvailable] IS NULL) OR ([QuantityAvailable] = @Original_QuantityAvailable)));
SELECT ItemID, Name, Description, Image, Price, ExpiryDate, QuantityAvailable FROM Items WHERE (ItemID = @ItemID)";
        ...
        public virtual int Insert(int ItemID, string Name, string Description, string Image, decimal Price, global::System.Nullable<global::System.DateTime> ExpiryDate, global::System.Nullable<int> QuantityAvailable) {
        ...
        public virtual int Update(int ItemID, string Name, string Description, string Image, decimal Price, global::System.Nullable<global::System.DateTime> ExpiryDate, global::System.Nullable<int> QuantityAvailable, int Original_ItemID, string Original_Name, string Original_Image, decimal Original_Price, global::System.Nullable<global::System.DateTime> Original_ExpiryDate, global::System.Nullable<int> Original_QuantityAvailable) {
            ...
            if ((Original_ExpiryDate.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((System.DateTime)(Original_ExpiryDate.Value));
            }
            else {
            ...
            if ((Original_QuantityAvailable.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((int)(Original_QuantityAvailable.Value));
            }
            else {
        ...
        public virtual int Update(string Name, string Description, string Image, decimal Price, global::System.Nullable<global::System.DateTime> ExpiryDate, global::System.Nullable<int> QuantityAvailable, int Original_ItemID, string Original_Name, string Original_Image, decimal Original_Price, global::System.Nullable<global::System.DateTime> Original_ExpiryDate, global::System.Nullable<int> Original_QuantityAvailable) {
            return this.Update(Original_ItemID, Name, Description, Image, Price, ExpiryDate, QuantityAvailable, Original_ItemID, Original_Name, Original_Image, Original_Price, Original_ExpiryDate, Original_QuantityAvailable);
        }
    }
